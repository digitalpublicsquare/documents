...
By agreeing to these Terms, you represent that you are at least the age of 18 and are a resident of Ethiopia.
...
We are not responsible if information, medical or otherwise, made available on this Site are not accurate, complete, or current. The materials on this Site are provided for general information only and should not be relied upon or used for making decisions without consulting primary, more accurate, more complete, or more timely sources of information, including your family physician. Any reliance on the material on this Site is at your own risk.
